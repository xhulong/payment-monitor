...
export const constantRoutes: RouteRecordRaw[] = [
  {
    ...
    hidden: true,
    meta: { title: 'LuLuPay 官网' }
  },
  {
    path: '/guide',
    component: () => import('@/views/public/guide/index.vue'),
    hidden: true,
    meta: { title: 'LuLuPay 使用教程' }
  },
  {
    path: '/redirect',
    component: Layout,
  ...
  },
  {
    ...
    children: [
      {
        path: ':token',
        component: () => import('@/views/merchant-invitation.vue'),
...
const router = createRouter({
  history: createWebHistory(normalizeContextPath(import.meta.env.VITE_APP_CONTEXT_PATH)),
