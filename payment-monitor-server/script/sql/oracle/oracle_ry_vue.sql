...
insert into sys_menu values(1761400000000000004, 'LuLuPay项目', 0, 9, 'https://github.com/xhulong/payment-monitor-server', null, '', 'Y', 'Y', 'M', '0', '0', '', 'guide', '', '', 1761000000000000103, 1761100000000000001, sysdate, null, null, 'LuLuPay项目地址');
-- 二级菜单
