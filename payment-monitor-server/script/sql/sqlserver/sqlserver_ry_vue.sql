...
GO
GO
insert into sys_menu values(1761400000000000004, N'LuLuPay项目', 0, 9, N'https://github.com/xhulong/payment-monitor-server', null, N'', N'Y', N'Y', N'M', N'0', N'0', N'', N'guide', N'', N'', 1761000000000000103, 1761100000000000001, getdate(), null, null, N'LuLuPay项目地址');
GO
