...
(
    ...
    `token`             varchar(64)         NOT NULL DEFAULT 'SJ_xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx' COMMENT 'token',
...
INSERT INTO `sj_group_config` VALUES (1, 'dev', 'ruoyi_group', '', 'SJ_xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx', 1, 1, 0, 1, 1,  now(), now());
INSERT INTO `sj_group_config` VALUES (2, 'prod', 'ruoyi_group', '', 'SJ_xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx', 1, 1, 0, 1, 1,  now(), now());
